...
public class SaveFoodStirngs {
	
         public static final String[] FOODS={"猪肉", "猪肝", "猪血", "羊肉", "牛肉", "牛肝", "鹅肉", "兔肉", "狗肉",
 			"鸭肉", "鸡肉", "驴肉", "鸡蛋", "鲤鱼", "黄鱼", "虾", "虾皮", "螃蟹", "蛤", "鳖肉",
 			"田螺", "大蒜", "葱", "萝卜", "芹菜", "韭菜", "菠菜", "莴笋", "竹笋", "西红柿", "洋葱",
 			"醋", "茶", "豆浆", "红糖", "蜂蜜", "牛奶", "白酒", "啤酒"};
         public static final String[] INFOS={"猪肉是目前人们餐桌上最常见的肉类食物之一，猪瘦肉中富含铁，容易被人体吸收，能预防贫血。猪肉味甘咸，性平，有补虚、滋阴、养血、润燥的功效。"
         ...
         public static final String[] FOODS2={"黄莲", "荞麦 雀肉 豆芽", "何首乌 地黄 黄豆 海带", "醋 红豆 半夏 南瓜",
         ...
         public static final int[] IMAGEID={ R.drawable.pork, R.drawable.pigliver, R.drawable.pigblood,
